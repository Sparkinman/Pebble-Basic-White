...
font_moon = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_MOON_PHASES_SUBSET_30));
  ...
  text_layer_set_text_color(&secondLayer, GColorBlack);
  ...
  text_layer_set_text_color(&amLayer, GColorBlack);
  ...
  text_layer_set_text_color(&monthLayer, GColorBlack);
  ...
  text_layer_set_font(&monthLayer, fonts_get_system_font(FONT_KEY_GOTHIC_28_BOLD));
    ...
    text_layer_set_text_color(&riseLayer, GColorBlack);
    ...
    text_layer_set_text_color(&setLayer, GColorBlack);
